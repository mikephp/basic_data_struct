...
Legal issues: Copyright (C) 1999-2004 by François PIETTE
...
{$ELSE}
    WinTypes, WinProcs,
{$ENDIF}
    SysUtils, Classes, WSocket, Winsock;

const
    WSocketServerVersion     = 502;
    CopyRight : String       = ' TWSocketServer (c) 1999-2004 F. Piette V5.02 ';
