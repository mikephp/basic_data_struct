...
// $Id: JclDebug.pas,v 1.1 2005/02/14 19:26:25 bert Exp $
...
type
  ...
  public
    ...
    procedure GetStackTrace(StackTrace: PDWORDArray; IncludeModuleName: Boolean = False;
      IncludeAddressOffset: Boolean = False; IncludeStartProcLineOffset: Boolean = False;
      IncludeVAdress: Boolean = False);
...
procedure TJclStackInfoList.GetStackTrace(StackTrace: PDWORDArray; IncludeModuleName, IncludeAddressOffset,
  IncludeStartProcLineOffset, IncludeVAdress: Boolean);
var
  I: Integer;
begin
     for I := 0 to Count - 1 do
       StackTrace^[i] := DWORD(Items[I].CallerAdr);
     StackTrace^[Count] := $FFFFFFFF;
end;
