...
//function TransmitFile;	external WINSOCK2_DLL name 'TransmitFile';
//function AcceptEx;    external  WINSOCK2_DLL name 'AcceptEx';
//procedure GetAcceptExSockaddrs;  external WINSOCK2_DLL name 'GetAcceptExSockaddrs';
...
//function WSARecvEx;	external WINSOCK2_DLL name 'WSARecvEx';
