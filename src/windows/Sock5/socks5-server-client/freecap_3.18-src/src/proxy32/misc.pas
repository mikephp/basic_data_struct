 ...
 * Desc: ...................... Miscleanous functions
 ...
 $Id: misc.pas,v 1.4 2005/04/18 04:49:55 bert Exp $

 $Log: misc.pas,v $
 Revision 1.4  2005/04/18 04:49:55  bert
 *** empty log message ***

 Revision 1.3  2005/03/08 16:29:08  bert
 *** empty log message ***
...
interface
uses  Windows, SysUtils, tlhelp32, winsock2;
...
begin
     ...
     begin
          if not isDirExists(Buf + '\FreeCap') then
             CreateDir(Buf + '\FreeCap');
          result := Buf + '\FreeCap\freecap.xml'
     end
     else
     begin
        GetWindowsDirectory(@Buf, SizeOf(Buf));
        result := Buf + '\freecap.xml';
     end;
end;
